     ...
     <div id="mostrar_mensaje"></div>
      ...
      <div class="modal fade" id="modificar">
		...
		<div class="form-group row ">
		 Municipio Compra:
		 <div class="col-lg-12">
		  <input type="text" class="form-control" id="municipio_compra1" name="municipio_compra1"><br>
		 </div>
		</div>
...
$(document).on("click", ".editar", function(){		        
    ...
    unidad = fila.find('td:eq(5)').text();
    numero_estopas = fila.find('td:eq(6)').text();
    estado_estopas = fila.find('td:eq(7)').text();
    numero_sacos = fila.find('td:eq(8)').text();
    estado_sacos = fila.find('td:eq(9)').text();
    latas = fila.find('td:eq(10)').text();
    kilos_brutos = fila.find('td:eq(11)').text();
    kilos_netos = fila.find('td:eq(12)').text();
    fecha = fila.find('td:eq(13)').text();
