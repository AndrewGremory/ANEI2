...
<!-- ----------------- CONSULTA--------------------------------->  
    ...
    cedula_secado = fila.find('td:eq(1)').text();
    tipo_usuario = fila.find('td:eq(2)').text();
    municipio_secado = fila.find('td:eq(3)').text();
    producto_secado = fila.find('td:eq(4)').text();
    numero_latas = fila.find('td:eq(5)').text();
    humedad_secado = fila.find('td:eq(6)').text();
    tiposecado_resultado = fila.find('td:eq(7)').text();
    observaciones_secado = fila.find('td:eq(8)').text();
